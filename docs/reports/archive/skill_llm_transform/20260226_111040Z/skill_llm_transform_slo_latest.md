...
- autonomous success rate: 93.7% (104/111, target >= 80.0%)
- autonomous attempt rate: 79.9% (159/199)
- autonomous success over attempts: 65.4% (104/159)
- llm planner failed rate: 0.0% (0/199, target <= 20.0%)
- verification failed rate: 0.0% (0/199, target <= 25.0%)
- guardrail degrade rate: 11.6% (23/199, target <= 40.0%)
- fallback rate: 32.7% (65/199, target <= 10.0%)
- verdict: FAIL
...
## Gate Reasons
- fallback_rate_above_target: 0.327 > 0.100
- autonomous_success_over_attempt_below_target: 0.654 < 0.700
