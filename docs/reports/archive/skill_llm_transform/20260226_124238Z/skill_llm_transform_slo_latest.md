...
- sample size: 193 (min required: 30)
- autonomous success rate: 97.2% (35/36, target >= 80.0%)
- autonomous attempt rate: 40.4% (78/193)
- autonomous success over attempts: 44.9% (35/78)
- llm planner failed rate: 0.0% (0/193, target <= 20.0%)
- verification failed rate: 0.0% (0/193, target <= 25.0%)
- guardrail degrade rate: 7.8% (15/193, target <= 40.0%)
- fallback rate: 22.3% (43/193, target <= 10.0%)
- verdict: FAIL
...
## Gate Reasons
- fallback_rate_above_target: 0.223 > 0.100
- autonomous_attempt_rate_below_target: 0.404 < 0.500
