...
def main() -> int:
    ...
    checklist = {
        ...
        "transform_fallback_rate_le_10": bool(transform_error_rate <= 0.10 and transform_denom > 0),
        "verify_fail_before_write_eq_0": bool(verify_fail_before_write == 0),
        "stage6_core_regression_pass": bool(args.stage6_core_pass),
        "canary_100_no_rollback": bool("rollout_100" in rollout_reasons and _as_int(rollout_reasons.get("rollout_100"), 0) > 0),
        "new_service_onboarded_without_hardcoding": False,
        "intent_error_rate_2w_improved": False,
    ...
    summary = {
        ...
        "pending_manual_checks": [
            "new_service_onboarded_without_hardcoding",
            "intent_error_rate_2w_improved",
        ],
    }
