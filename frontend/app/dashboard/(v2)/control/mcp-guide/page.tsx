...
export default function DashboardMcpGuidePage() {
  ...
  return (
    <section className="space-y-4">
      ...
      <p className="text-sm text-[var(--text-secondary)]">Quick copy examples for JSON-RPC `list_tools` and `call_tool` usage.</p>
      ...
      <article className="ds-card p-4">
        ...
        <pre className="overflow-x-auto rounded bg-[var(--surface-subtle)] p-3 text-[11px] text-[var(--text-secondary)]">{examples.listTools}</pre>
      </article>
      ...
      <article className="ds-card p-4">
        ...
        <pre className="overflow-x-auto rounded bg-[var(--surface-subtle)] p-3 text-[11px] text-[var(--text-secondary)]">{examples.callTool}</pre>
      </article>

      <article className="ds-card p-4">
        <p className="text-xs text-[var(--muted)]">Tip: replace `metel_xxx` with your API key and adjust `tool_name`/`arguments` per connector schema.</p>
      </article>
    </section>
  );
}
